...
const ProfileProgress: React.FC<ProfileMainProps> = ({ profileData }) => {
  ...
  return (
    <div className=" min-w-full flex  flex-col justify-between  items-center w-full shadow-xl bg-sky-900 lg:border-1 border-zinc-200 text-slate-200 border-opacity-50   px-5 rounded-xl py-5  h-full mt-5 lg:mt-0  ">
      {" "}
